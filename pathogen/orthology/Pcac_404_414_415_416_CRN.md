...
```bash
  ...
  cd $ProjDir
  IsolateAbrv=Pcac_404_414_415_416_CRN
...
```bash
  Taxon_code=P404
  Fasta_file=analysis/CRN_effectors/hmmer_CRN/P.cactorum/404/404_final_CRN.fa
  Id_field=1
...
```bash
  Taxon_code=P414
  Fasta_file=analysis/CRN_effectors/hmmer_CRN/P.cactorum/414/414_final_CRN.fa
  Id_field=1
  orthomclAdjustFasta $Taxon_code $Fasta_file $Id_field
  mv "$Taxon_code".fasta $WorkDir/formatted/"$Taxon_code".fasta
```
...
```bash
  Taxon_code=P415
  Fasta_file=analysis/CRN_effectors/hmmer_CRN/P.cactorum/415/415_final_CRN.fa
  Id_field=1
  orthomclAdjustFasta $Taxon_code $Fasta_file $Id_field
  mv "$Taxon_code".fasta $WorkDir/formatted/"$Taxon_code".fasta
```
...
```bash
  Taxon_code=P416
  Fasta_file=analysis/CRN_effectors/hmmer_CRN/P.cactorum/416/416_final_CRN.fa
  Id_field=1
  orthomclAdjustFasta $Taxon_code $Fasta_file $Id_field
  mv "$Taxon_code".fasta $WorkDir/formatted/"$Taxon_code".fasta
```
