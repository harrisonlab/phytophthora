...
for line in orthogroup_lines:
    ...
    # expansion_status = get_orthogroup_expansion_status2(orthogroup_content_dict)
    expansion_status = get_orthogroup_expansion_status3(orthogroup_content_dict)
    content_str = ",".join(split_line[1:])
    outline = "\t".join([orthogroup_id, expansion_status, content_counts])
    print(outline)
