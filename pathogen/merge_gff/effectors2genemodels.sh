...
RxlrDB_mod=tmp7.db # 414_rxlr_note.db
Rxlr_Wy_DB=tmp7.db # 414_rxlr_WY.db

OrfMerged=tmp8.db # 414_rxlr_WY_merged.db
MergedDB=tmp9.db # 414_Aug_ORF_merged.db
FinalDB=tmp10.db # 414_Aug_ORF.db
FinalGff=tmp11.db # 414_Aug_ORF.gff

FinalDB_mod1=tmp12.db # 414_Aug_ORF_mod1.db
FinalDB_mod2=$6 # 414_Aug_ORF_full_rxlr.db
FinalGff_mod2=$7 # 414_effectors.gff
