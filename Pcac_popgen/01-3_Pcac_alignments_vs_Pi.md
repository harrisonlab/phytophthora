...
# 1. Alignment of Pcac raw reads vs the 371 genome
...
```bash
  ...
  for StrainPath in $(ls -d ../../../../home/groups/harrisonlab/project_files/idris/qc_dna/paired/P.*/* | grep -w -v -e '10300' -e '415' -e '416' -e 'PC13_15' -e '2003_3' | grep -e 'P.cactorum' -e 'P.idaei'); do
    ...
    echo $F_Read
    echo $R_Read
    OutDir=analysis/genome_alignment/bowtie/$Organism/$Strain/vs_371
...
Reference=$(ls $ProjDir/repeat_masked/${Organism}/${Strain}/filtered_contigs_repmask/*_contigs_softmasked_repeatmasker_TPSI_appended.fa)
...
WARNING_TRANSCRIPT_INCOMPLETE	5
WARNING_TRANSCRIPT_NO_START_CODON	17
```


# 3.0 Comparisons of groups to reference P.idaei genome

# 3.1 P. idaei vs SCRP371
