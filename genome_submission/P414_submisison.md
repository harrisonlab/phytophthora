...
BFJ72 SAMN05529104 Fp_A8" \
> $LocusTags
for Assembly in $(ls repeat_masked/P.cactorum/*/filtered_contigs_repmask/*_contigs_unmasked.fa | grep -e '125' -e 'A23' | grep -v -e 'ncbi'); do
...
# Sbt Files
Ref_Sbt=$(ls genome_submission/P.cactorum/414_v2/template.sbt)
